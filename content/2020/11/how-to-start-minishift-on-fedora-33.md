...
+++
**update: minishift is bascially dead and won't support OpenShift 4. You probably want to use [crc](https://developers.redhat.com/blog/2019/09/05/red-hat-openshift-4-on-your-laptop-introducing-red-hat-codeready-containers/) instead.**

I just spent to much time trying to start [minishift](https://github.com/minishift/minishift) with my user account. After 3h fighting with permission issues between libvirt and the `~/.minishift` directory, I've finally decided to stay sane and use `sudo`... This is how I start minishift on my Fedora-33.
